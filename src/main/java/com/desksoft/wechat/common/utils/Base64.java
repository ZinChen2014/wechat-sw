...
public class Base64 {
	...
	private static final byte[] _NATIVE_ALPHABET = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H',
	...
	private static final byte WHITE_SPACE_ENC = -5; // Indicates
	// white
	// space
	// in
	// encoding
	private static final byte EQUALS_SIGN_ENC = -1; // Indicates
	...
	public static String StringToBase64(String message) {
		...
		String base64;
		try {
			base64 = base64Encoder.encode(message.getBytes("utf-8"));
	...
	public static String Base64ToString(String base64) {
		...
		byte[] message;
		try {
			message = decoder.decodeBuffer(base64);
		} catch (IOException e) {
			message = new byte[0];
		}
