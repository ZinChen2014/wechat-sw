...
public class StringUtil {
	 ...
	 * @return 连接后的字符串，如果原数组为<code>null</code>，则返回<code>null</code>
	 */
	public static String join(@SuppressWarnings("rawtypes") Iterator iterator, char separator) {
		if (iterator == null) {
			return null;
		}
	...
	public static String hash(Object key) {
	...
	/**
	 * @author LiuWenLong
	 * @version 2013-3-4 下午2:54:58
	 * @description 将用','隔开的数字字符串转换成long list
	 * @param str
	 * @return
	 */
	public static List<Long> stringToLong(String str) {
		List<Long> numbers = new ArrayList<Long>();
		String[] arrTeamIds = str.split(",");
		for (String s : arrTeamIds) {
	 ...
	 * @return
	 */
	public static String format(String separator, List<Object> args) {
		return format(separator, args.toArray(new Object[] {}));
	}
	 ...
	 * @return
	 */
	public static String format(String separator, Object... args) {
		return Joiner.on(separator).skipNulls().join(args);
	}

	/**
	 * 把字符串中包含的各个出现的多个空格替换成一个
	 * 
	 * @param string
	 * @return
	 */
	public static String multiSpace2One(String string) {
	 ...
	 * @return
	 */
	public static String[] splitter(String separator, CharSequence cs) {
		List<String> vals = Lists.newLinkedList();

		Iterator<String> iter = Splitter.on(separator).split(cs).iterator();
		while (iter.hasNext()) {
	 ...
	 */
	public static String encodeDownLoadName(HttpServletRequest request, String fileName) throws UnsupportedEncodingException {
	...
	/**
	 * 判断Js传过来的字符串参数是否为空 ---- 当字符串不为null, '', 'null', 'undefined'
	 * 
	 * @param str
	 */
	public static boolean isEmptyJs(String str) {
	...
	public static String[] split2(String str, String seperators) {
	...
	/**
	 * 格式化号码，不够位数的左补0 例： fmtNo(1, 8) 返回00000001
	 */
	public static String fmtNo(Integer exNo, int len) {
		StringBuffer ex = new StringBuffer(exNo + "");
		int cur_len = ex.length();
	 ...
	 * @return
	 */
	public static boolean eq(String str, String[] strs) {
	...
	/**
	 * @Description 字符串是否是合法emil
	 * @param phonStr
	 * @return
	 */
	public static boolean isEmailString(String emailStr) {
		if (StringUtil.isBlank(emailStr)) {
			return false;
		}
	...
	/**
	 * @Description 字符串是否是合法手机号
	 * @param phonStr
	 * @return
	 */
	public static boolean isPhoneNumberString(String phonStr) {
		if (StringUtil.isBlank(phonStr)) {
			return false;
		}
		Pattern mobilePattern = Pattern.compile("^[1]([3][0-9]{1}|5[0-9]|8[0-9])[0-9]{8}$");
		Matcher mobileMatcher = mobilePattern.matcher(phonStr);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static String listToCaseString(List list) {
